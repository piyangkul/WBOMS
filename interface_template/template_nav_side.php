...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a <?php if ($p == "discount_shop") echo 'class="active-menu"'; ?> href="../discount_shop/discount_shop.php"><i class="fa fa-dollar fa-3x"></i> Discount Shop </a>
            </li>
            <li>
            ...
            <li>
                <a <?php if ($p == "docket") echo 'class="active-menu"'; ?> href="#"><i class="fa fa-file-text-o fa-3x"></i> Cover Page </a>
            </li>
            <li>
...
<script src="https://pagead2.googlesyndication.com/pub-config/ca-pub-9366031574447333.js"></script>
