...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a <?php if($p=="history_order") echo 'class="active-menu"';?>  href="../interface_history_order/history_order.php"><span class="fa fa-folder-open-o fa-3x"></span> History Order</a>
            </li>
            <li>
