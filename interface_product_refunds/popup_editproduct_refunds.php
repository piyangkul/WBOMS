...
$idunit = $_GET['idunit'];
$amount = $_GET['amount'];
/* $AmountPerUnit = $getUnit3['amount_unit'];

  $price = $getUnit3['price_unit'];
  $type = $getUnit3['type_unit'];
  $idProduct = $getUnit3['idproduct'];

  $getAllUnit = getProductUnit($idProduct)0 */;
?>
        ...
        <div class="form-group col-xs-12">
            ...
            <div class="form-group col-xs-12">
               ...
               <!-- <select class="form-control" id="factoryName" name="factoryName" onchange ="LoadFactory(this.value)" required >
                ...
                <?php /* } */ ?>
                <!--  </select>-->
                <input type="text" class="form-control" id="name_factory" name="name_factory" placeholder="กรุณาระบุโรงงาน" value ="<?= $nameFactory ?>" disabled>
                <h id="idFactory2"></h>
            </div>
            ...
            <div class="form-group col-xs-12">
                ...
                <input type="text" class="form-control" id="name_product" name="name_product" placeholder="กรุณาระบุสินค้า" value ="<?= $nameProduct ?>" disabled>
            </div>
            <div class="form-group col-xs-12">
                ...
                <select class="form-control" id="idUnit" name="idUnit" onchange="LoadData(this.value)" required>
                    <option selected value="<?= $idu.nit ?>"><?= $nameUnit ?></option>   
                    <?php
                    ...
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive ">
                                ...
                                <?php if ($type === "BATH") { ?>
                                    <label><b> ขายลดเปอร์เซ็นต์</b></label>
                                    <input type = "text" class = "form-control" placeholder = "กรอก%ขายลด" id = "DifferencePer" value = "" onkeyup = "updateTotalPer()" disabled />
                                    <label class = "radio">
                                        <input type = "radio" name = "inlineRadioOptions"> ขายเพิ่มสุทธิ
                                        <input type = "text" class = "form-control" placeholder = "กรอกราคาขายเพิ่มสุทธิ" id = "DifferenceBath" value = "<?= $diffBath; ?>"updateTotalBath()"/>
                                    </label>
                                <?php } elseif ($type === "PERCENT") {
                                    ?>
                                    <label><b> ขายลดเปอร์เซ็นต์</b></label>
                                    <input type = "text" class = "form-control" placeholder = "กรอก%ขายลด" id = "DifferencePer" value = "<?= $diffPer; ?>" onkeyup = "updateTotalPer()" />
                                    <label class = "radio">
                                        <input type = "radio" name = "inlineRadioOptions"> ขายเพิ่มสุทธิ
                                        <input type = "text" class = "form-control" placeholder = "กรอกราคาขายเพิ่มสุทธิ" id = "DifferenceBath" value = "" onkeyup="updateTotalBath()" disabled=""/>
                                    </label>
                                    <?php
                                }
                                ?>
