                ...
                <div id="page-inner">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <a href="popup_add_payfactory.php?idshipment_period=<?php echo $idshipment_period; ?>&idfactory=<?php echo $idfactory; ?>&price=<?php echo $price;?>" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal-lg">
