...
<form class="form" action="" method="POST">
    ...
    <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">ตารางข้อมูลการเก็บเงิน(ประเภทเก็บไม่ครบและจ่ายเกินเวลา) <?php //echo $name_shop;    ?> </h4>
    </div>
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <div class="form-group col-xs-12">
                ...
                <table class="table table-striped table-bordered table-hover text-center" id="dataTables-example"> 
                    ...
                    <tbody>
                        <?php
                        $getPay_lack = getPay_get_and_lack($idshop, $status_pay, $status_due);
                        $i = 0;
                        foreach ($getPay_lack as $value) {
                            $i++;
